              ...
              <div className="text-sm text-slate-600 space-y-1">
                {selected.street && (
                  <div className="flex items-center gap-2">
                    ...
                    <span>{selected.street}{selected.houseNumber ? ` ${selected.houseNumber}` : ''}</span>
                  </div>
                )}
                {selected.city && (
                  <div className="flex items-center gap-2">
                    <span className="text-slate-400">City:</span>
                    <span>{selected.city}{selected.state ? `, ${selected.state}` : ''}{selected.postcode ? ` ${selected.postcode}` : ''}</span>
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 text-xs">
              {selected.planning ? (
                <>
                  ...
                  <span className="text-green-700 font-medium">Planning attributes retrieved successfully</span>
                </>
              ) : (
                <>
