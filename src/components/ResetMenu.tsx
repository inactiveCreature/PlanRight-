            ...
            <div className="py-1">
              ...
              >
                ...
                <div className="flex-1">
                  <div className="font-semibold text-slate-900 group-hover:text-blue-900">Reset {getStepDisplayName(currentStep)}</div>
                  <div className="text-xs text-slate-500 mt-1">Clear only this step's fields</div>
                </div>
                <svg className="w-4 h-4 text-slate-400 group-hover:text-blue-600 transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              >
                ...
                <div className="flex-1">
                  <div className="font-semibold text-red-900 group-hover:text-red-800">Reset All Fields</div>
