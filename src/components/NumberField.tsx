...
export function NumberField({
  ...
  const baseClasses = "w-full rounded-xl border px-3 py-2 text-slate-900 focus:outline-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 transition-all duration-200"
