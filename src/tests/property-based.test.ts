...
describe('Property-Based Tests for Rules Engine', () => {
  ...
  describe('Determinism Properties', () => {
    it('should produce identical results for identical inputs', () => {
      fc.assert(
        fc.property(proposalArbitrary, (proposal) => {
        ...
        fc.property(
          ...
          ({ lotSize, area, sideSetback, rearSetback }) => {
            const proposal: Proposal = {
              ...
              location: {
                setback_front_m: 6,
                setback_side_m: sideSetback,
                setback_rear_m: rearSetback,
        ...
        fc.property(
          ...
          ({ heritage, conservation }) => {
            const proposal: Proposal = {
              ...
              context: {
                heritage_item_bool: heritage,
                conservation_area_bool: conservation,
                flood_prone_bool: false,
                bushfire_bool: false,
              },
            }
      ...
      fc.assert(
        fc.property(proposalArbitrary, (proposal) => {
          ...
          const expectedStructureRules =
            structureType === 'shed' ? 10 : structureType === 'patio' ? 8 : 9
