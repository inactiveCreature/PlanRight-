...
describe('NSW SEPP Part 2 - Comprehensive Rules Testing', () => {
  ...
  describe('Shed Rules (Subdivision 9)', () => {
    ...
    it('A1: Shed, RU2, 40m², h=2.8m, side=6m, rear=6m, behind line=true → Likely Exempt', () => {
      const proposal = {
        property: { id: 'X', lot_size_m2: 400, zone_text: 'RU2', frontage_m: 10, corner_lot_bool: false, easement_bool: false },
        structure: { type: 'shed' as StructureType },
        dimensions: { length_m: 8, width_m: 5, height_m: 2.8, area_m2: 40 },
        location: { setback_front_m: 6, setback_side_m: 6, setback_rear_m: 6, behind_building_line_bool: true },
    ...
    it('A3: Shed, R3, 22m², side=0.85m → Fail setback residential (S-SIDE-1)', () => {
      const proposal = {
        property: { id: 'X', lot_size_m2: 400, zone_text: 'R3', frontage_m: 10, corner_lot_bool: false, easement_bool: false },
        structure: { type: 'shed' as StructureType },
        dimensions: { length_m: 5.5, width_m: 4, height_m: 2.8, area_m2: 22 },
        location: { setback_front_m: 1, setback_side_m: 0.85, setback_rear_m: 1, behind_building_line_bool: true },
        siting: { on_easement_bool: false, over_sewer_bool: false, attached_to_dwelling_bool: false },
        context: { heritage_item_bool: false, conservation_area_bool: false, flood_prone_bool: false, bushfire_bool: false },
      }
      const result = run_rules_assessment(proposal)
    ...
    it('A4: Shed, R5, 48m², side=4.9m → Fail setback rural (S-SIDE-1)', () => {
      const proposal = {
        ...
        location: { setback_front_m: 6, setback_side_m: 4.9, setback_rear_m: 6, behind_building_line_bool: true },
        siting: { on_easement_bool: false, over_sewer_bool: false, attached_to_dwelling_bool: false },
        context: { heritage_item_bool: false, conservation_area_bool: false, flood_prone_bool: false, bushfire_bool: false },
      }
      const result = run_rules_assessment(proposal)
    ...
    it('A6: Shed, R1, 10m from dwelling, bushfire=true, non_combustible=false → Fail (S-BUSHFIRE-NC-1)', () => {
      const proposal = {
        property: { id: 'X', lot_size_m2: 400, zone_text: 'R1', frontage_m: 10, corner_lot_bool: false, easement_bool: false },
        structure: { type: 'shed' as StructureType },
        dimensions: { length_m: 4, width_m: 4, height_m: 2.8, area_m2: 16 },
        location: { setback_front_m: 1, setback_side_m: 1, setback_rear_m: 1, behind_building_line_bool: true },
        siting: { on_easement_bool: false, over_sewer_bool: false, attached_to_dwelling_bool: false },
        context: { heritage_item_bool: false, conservation_area_bool: false, flood_prone_bool: true, bushfire_bool: true },
      }
      const result = run_rules_assessment(proposal)
  ...
  describe('Patio Rules (Subdivision 6)', () => {
    ...
    it('B2: Patio, R2, lot=290m², patio=25m², floor_h=0.9m, walls=1.3m, setbacks=0.9m, behind line=true → Pass (edge)', () => {
      const proposal = {
        property: { id: 'X', lot_size_m2: 290, zone_text: 'R2', frontage_m: 10, corner_lot_bool: false, easement_bool: false },
        structure: { type: 'patio' as StructureType },
        dimensions: { length_m: 5, width_m: 5, height_m: 2.8, area_m2: 25 },
        location: { setback_front_m: 0.9, setback_side_m: 0.9, setback_rear_m: 0.9, behind_building_line_bool: true },
        siting: { on_easement_bool: false, over_sewer_bool: false, attached_to_dwelling_bool: true },
        context: { heritage_item_bool: false, conservation_area_bool: false, flood_prone_bool: false, bushfire_bool: false },
      }
      const result = run_rules_assessment(proposal)
    ...
    it('B3: Patio, RU1, behind_line=false but ≥50m to road → Pass siting; still check ≥5m setbacks', () => {
      const proposal = {
        property: { id: 'X', lot_size_m2: 1000, zone_text: 'RU1', frontage_m: 10, corner_lot_bool: false, easement_bool: false },
        structure: { type: 'patio' as StructureType },
        dimensions: { length_m: 5, width_m: 4, height_m: 2.8, area_m2: 20 },
        location: { setback_front_m: 50, setback_side_m: 5, setback_rear_m: 5, behind_building_line_bool: false },
        siting: { on_easement_bool: false, over_sewer_bool: false, attached_to_dwelling_bool: true },
        context: { heritage_item_bool: false, conservation_area_bool: false, flood_prone_bool: false, bushfire_bool: false },
      }
      const result = run_rules_assessment(proposal)
  ...
  describe('Carport Rules (Subdivision 10)', () => {
    ...
    it('C1: Carport, R3, 24m², h=2.9m, 1m behind line, side=0.9m, roof_to_boundary=0.4m → Fail clearance', () => {
      const proposal = {
        ...
        location: { setback_front_m: 1, setback_side_m: 0.9, setback_rear_m: 1, behind_building_line_bool: true },
        siting: { on_easement_bool: false, over_sewer_bool: false, attached_to_dwelling_bool: true },
        context: { heritage_item_bool: false, conservation_area_bool: false, flood_prone_bool: false, bushfire_bool: false },
      }
      const result = run_rules_assessment(proposal)
    ...
    it('C2: Carport, R5, 48m², side=5m, rear=5m, 1m behind line → Pass (rural caps)', () => {
      const proposal = {
        ...
        structure: { type: 'carport' as StructureType },
        dimensions: { length_m: 8, width_m: 6, height_m: 2.8, area_m2: 48 },
        location: { setback_front_m: 1, setback_side_m: 5, setback_rear_m: 5, behind_building_line_bool: true },
        siting: { on_easement_bool: false, over_sewer_bool: false, attached_to_dwelling_bool: true },
        context: { heritage_item_bool: false, conservation_area_bool: false, flood_prone_bool: false, bushfire_bool: false },
      }
      const result = run_rules_assessment(proposal)
  ...
  describe('General Exclusion Rules', () => {
    ...
    it('D2: Easement present and structure within 1m → Fail easement rule', () => {
      const proposal = {
        property: { id: 'X', lot_size_m2: 400, zone_text: 'R2', frontage_m: 10, corner_lot_bool: false, easement_bool: true },
        structure: { type: 'shed' as StructureType },
        dimensions: { length_m: 4, width_m: 4, height_m: 2.8, area_m2: 16 },
        location: { setback_front_m: 1, setback_side_m: 0.5, setback_rear_m: 0.5, behind_building_line_bool: true },
        siting: { on_easement_bool: false, over_sewer_bool: false, attached_to_dwelling_bool: false },
        context: { heritage_item_bool: false, conservation_area_bool: false, flood_prone_bool: false, bushfire_bool: false },
      }
      const result = run_rules_assessment(proposal)
    ...
    it('D3: Unknown zone_text → Cannot assess with errors[] describing unmapped zone', () => {
      const proposal = {
        property: { id: 'X', lot_size_m2: 400, zone_text: 'INVALID_ZONE', frontage_m: 10, corner_lot_bool: false, easement_bool: false },
        structure: { type: 'shed' as StructureType },
        dimensions: { length_m: 4, width_m: 4, height_m: 2.8, area_m2: 16 },
        location: { setback_front_m: 1, setback_side_m: 1, setback_rear_m: 1, behind_building_line_bool: true },
        siting: { on_easement_bool: false, over_sewer_bool: false, attached_to_dwelling_bool: false },
  ...
  describe('Edge Cases and Boundary Conditions', () => {
    ...
    it('Setback exactly at 0.9m limit for residential → Pass', () => {
      const proposal = {
        ...
        structure: { type: 'shed' as StructureType },
        dimensions: { length_m: 4, width_m: 4, height_m: 2.8, area_m2: 16 },
        location: { setback_front_m: 1, setback_side_m: 0.9, setback_rear_m: 0.9, behind_building_line_bool: true },
        siting: { on_easement_bool: false, over_sewer_bool: false, attached_to_dwelling_bool: false },
        context: { heritage_item_bool: false, conservation_area_bool: false, flood_prone_bool: false, bushfire_bool: false },
      }
      const result = run_rules_assessment(proposal)
    ...
    it('Setback exactly at 5.0m limit for rural → Pass', () => {
      const proposal = {
        ...
        structure: { type: 'shed' as StructureType },
        dimensions: { length_m: 4, width_m: 4, height_m: 2.8, area_m2: 16 },
        location: { setback_front_m: 6, setback_side_m: 5.0, setback_rear_m: 5.0, behind_building_line_bool: true },
        siting: { on_easement_bool: false, over_sewer_bool: false, attached_to_dwelling_bool: false },
        context: { heritage_item_bool: false, conservation_area_bool: false, flood_prone_bool: false, bushfire_bool: false },
      }
      const result = run_rules_assessment(proposal)
  ...
  describe('Determinism Tests', () => {
    ...
    it('All rules are evaluated regardless of early failures', () => {
      const proposal = {
        ...
        location: { setback_front_m: 1, setback_side_m: 0.5, setback_rear_m: 0.5, behind_building_line_bool: true }, // Setbacks fail
        siting: { on_easement_bool: false, over_sewer_bool: false, attached_to_dwelling_bool: true }, // Attachment fails for shed
        context: { heritage_item_bool: false, conservation_area_bool: false, flood_prone_bool: false, bushfire_bool: false },
      }
