...
test.describe('Step Completion Behavior', () => {
  ...
  test('Structure step shows "To do" on load and flips to "Complete" when selecting "Patio"', async ({
    page,
  }) => {
  ...
  test('Siting step flips to "Complete" after pressing Next without toggling fields', async ({
    page,
  }) => {
